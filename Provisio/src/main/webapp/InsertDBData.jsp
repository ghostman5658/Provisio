...
<body>
    ...
    <%
      ...
      //Attempt to populate hotel table with data
        ...
        //try{
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (1, 'Queen Room', 'queen', 131.25, 150, 1)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (2, 'Double Room', 'double full', 115.50, 150, 1)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (3, 'King Room', 'king', 173.25, 150, 1)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (4, 'Double Queen Room', 'double queen', 157.50, 150, 1)");
            
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (5, 'Queen Room', 'queen', 131.25, 150, 2)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (6, 'Double Room', 'double full', 115.50, 150, 2)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (7, 'King Room', 'king', 173.25, 150, 2)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (8, 'Double Queen Room', 'double queen', 157.50, 150, 2)"); 
            
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (9, 'Queen Room', 'queen', 131.25, 150, 3)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (10, 'Double Room', 'double full', 115.50, 150, 3)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (11, 'King Room', 'king', 173.25, 150, 3)"); 
            stmt.executeUpdate("INSERT INTO room(RoomId, Name, Size, BasePrice, Points, HotelId) VALUES (12, 'Double Queen Room', 'double queen', 157.50, 150, 3)"); 
